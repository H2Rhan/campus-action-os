...
状态：IN PROGRESS（截至 2026-09-14；远程 CI、main 封板和发布标签尚未完成）
...
正式 800 条数据、正式测试集冻结、AI 解析、真实模型/Prompt/规则、微信小程序业务、发布端业务、数据库、认证、正式实验、真实试点、远程 CI 运行记录、main 封板和发布标签，以及任何用户/效果指标。
